...
> Изменение в v5.2: `AGENTS.md` → `CLAUDE.md` (Claude Code convention). Логика «routing ≤200 строк» сохраняется, имя файла другое.
...
Или через marketplace `vibe-dev-v5`.
