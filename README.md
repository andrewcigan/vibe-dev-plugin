...
В v6.2 таких механизмов — **37**, каждый с тремя атрибутами: *где зафиксирован / чем enforce /
...
## Механизмы — что каждый ловит (ключевые из 37)
...
> Технический id плагина — `vibe-dev` (от него зависят имена команд и установка). Версия — **6.2.0**.
